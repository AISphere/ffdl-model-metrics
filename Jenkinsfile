...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMG_NAME = "ffdl-model-metrics"
        ...
        stage('git checkout') {
            steps {
                ...
                dir("$AISPHERE/ffdl-trainer") {
                    git branch: 'master', url: 'https://github.com/AISphere/ffdl-trainer.git'
                }
                    ...
                    checkout([$class: 'GitSCM', branches: [[name: "FETCH_HEAD"]],
                              ...
                              userRemoteConfigs: [
                                      [refspec: "+refs/pull/${env.CHANGE_ID}/head:refs/remotes/origin/PR-${env.CHANGE_ID}",
                                       url: "https://github.com/AISphere/ffdl-model-metrics.git"]]])
